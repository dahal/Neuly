...
class SellsControllerTest < ActionController::TestCase
  ...
  test "should create sell" do
    assert_difference('Sell.count') do
      post :create, sell: { description: @sell.description, domain: @sell.domain, premium: @sell.premium, price: @sell.price, regular: @sell.regular }
    end
  ...
  test "should update sell" do
    patch :update, id: @sell, sell: { description: @sell.description, domain: @sell.domain, premium: @sell.premium, price: @sell.price, regular: @sell.regular }
    assert_redirected_to sell_path(assigns(:sell))
  end
